...
func Upload(writer http.ResponseWriter, request *http.Request) {
	// request.ParseMultipartForm(32 << 20) // default max size allowed for file = 33554432, or 32 MB
...
func TestUploadFile(t *testing.T) {
	...
	file, _ := writer.CreateFormFile("file", "github-new.png")
